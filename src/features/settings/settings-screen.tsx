...
export function SettingsScreen() {
  ...
  async function load() {
    ...
    setActiveId(preferences.activeLanguagePairId);
    setPairs(await repo.listLanguagePairs(preferences.activeOwnerKey));
  }
  useEffect(() => { void load().catch((caught: unknown) => setError(caught instanceof Error ? caught.message : 'Could not load settings.')); }, [sqlite]);
